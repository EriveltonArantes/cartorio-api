...
|----------|---------|---------|
| `/api/registros` | GET / POST / PUT / DELETE | CRUD de Registro |
| `/api/certidaos` | GET / POST / PUT / DELETE | CRUD de Certidao |
| `/api/servicos` | GET / POST / PUT / DELETE | CRUD de Servico |
| `/api/solicitacaoservicos` | GET / POST / PUT / DELETE | CRUD de SolicitacaoServico |
